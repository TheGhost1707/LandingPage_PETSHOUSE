...
if($op == 'delete'){
    $id     = $_GET['id'];
    $sql1   = "DELETE FROM makanan_burung WHERE id = '$id' ";
...
if($op == 'edit'){
    $id     = $_GET['id'];
    $sql1   = "SELECT * FROM makanan_burung WHERE id = '$id' ";
    $qry1   = mysqli_query($koneksi,$sql1);
...
if($merk_makanan && $nama_makanan && $jenis_makanan && $harga){
    if($op == 'edit'){ // Fungsi untuk mengedit data
        $sql1 = "Update makanan_burung set merk_makanan = '$merk_makanan', nama_makanan = '$nama_makanan', jenis_makanan = '$jenis_makanan', harga = '$harga'  where id = '$id'";
        $qry1 = mysqli_query($koneksi,$sql1);
        if($qry1){
        ...
        $sql1 = "INSERT INTO makanan_burung(merk_makanan,nama_makanan,jenis_makanan,harga) values('$merk_makanan', '$nama_makanan', '$jenis_makanan','$harga')";
        $qry1 = mysqli_query($koneksi,$sql1);
    if($qry1){
                ...
                <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td>
                            <a href = "makanan-burung-admin.php?op=edit&id=<?php echo $id?>"><button type ="button" class = "">Edit</button></a>
                            <a href = "makanan-burung-admin.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Apakah anda yakin ingin menghapus data menu yang anda pilih ?')"><button type ="button" class = "">Delete</button></a>
                            <td>
                        </tr>
                        <?php
                        }
